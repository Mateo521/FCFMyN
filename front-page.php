        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 bg-slate-100">
            ...
            if (! empty($carreras_api) && is_array($carreras_api)) {
                foreach ($carreras_api as $carrera) {
                    ...
                    $is_pregrado = in_array('nivel-pregrado', $carrera->class_list) || in_array(9, $carrera->nivel);
            ...
            <div class="bg-gray-100 p-9 flex flex-col h-[550px]">
                ...
                <div class="flex-grow overflow-hidden  relative">
                    <ul class="space-y-4 h-full overflow-y-auto pr-4 custom-scroll scroll-fade pb-10">
            ...
            <div class="grado p-9 rounded flex flex-col h-[550px] transform md:-translate-y-4 shadow-xl relative z-10">
                ...
                <div class="flex-grow overflow-hidden relative">
                    <ul class="space-y-4 h-full overflow-y-auto pr-4 custom-scroll-dark scroll-fade pb-10">
                        ...
                        ?>
                                <li class="flex items-start gap-2.5">
                                    ...
                                    <a href="<?php echo esc_url($link_local); ?>" class="text-[13px] font-medium text-white/90 leading-snug hover:text-[#dd7859] transition-colors">
        ...
        <div class="max-w-7xl mx-auto">
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
                ...
                if ($secretarias_parent) {
                    $secretarias_args = array(
                        'post_type'      => 'page',
                        'post_parent'    => $secretarias_parent->ID,
                        'order'          => 'ASC',
                        'orderby'        => 'menu_order',
                        'posts_per_page' => -1,
                    );

                    $secretarias_query = new WP_Query($secretarias_args);
                ...
                ?>
                            <div class="bg-white p-7 shadow-sm hover:shadow-md transition-shadow duration-300 group rounded-sm flex flex-col justify-between">
                                <div>
                                    ...
                                    <!--div class="text-slate-500 text-[13px] leading-relaxed font-semibold">
                                        ...
                                        if (has_excerpt()) {
                                            ...
                                            $pos = strpos($contenido, '</p>');
                                            if ($pos !== false) {
                                                echo substr($contenido, 0, $pos + 4);
                                            } else {
                                                echo $contenido;
                                            }
                                        }
                                ...
                                <a href="<?php the_permalink(); ?>"
                                    style="color: <?php echo esc_attr($color_actual); ?>"
                    ...
                    ?>
                    <div class="col-span-full">
                        <p class="text-slate-500">No se encontró la página de secretarías.</p>
                    </div>
                <?php
                }
                ?>
